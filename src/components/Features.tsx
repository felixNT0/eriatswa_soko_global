...
const features = [
  {
    ...
    desc: "We source only the finest premium materials to ensure every product stands the test of time.",
  },
  {
    icon: <Gem size={32} />,
    title: "Neat Finishing",
    desc: "Professional finishing and precision in every stitch, reflecting our passion for excellence.",
  },
  {
    icon: <Award size={32} />,
    title: "Affordable Prices",
    desc: "Luxury that doesn't break the bank. We offer premium handcrafted goods at competitive prices.",
  },
  {
    icon: <Truck size={32} />,
    title: "Reliable Service",
    desc: "Trusted by individuals and wholesalers alike for prompt, professional, and reliable delivery.",
  },
];
          ...
          {features.map((f, i) => (
            ...
            >
              <div className="relative z-10">
                ...
                <h3 className="text-sm font-bold uppercase tracking-[0.2em] mb-4 text-foreground group-hover:text-primary transition-colors">
                  {f.title}
                </h3>
