  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-[100] transition-all duration-700 ${
        scrolled
          ? "py-4 bg-background/80 backdrop-blur-2xl shadow-2xl border-b border-white/5"
          : "py-8 bg-transparent"
      }`}
    >
      <div className="max-w-[1400px] mx-auto flex justify-between items-center px-6 md:px-12">
        <Link href="/" className="z-50 relative group">
          <div className="flex flex-col leading-none">
            ...
            <span className="text-[10px] font-sans font-bold tracking-[0.4em] block text-primary group-hover:text-foreground transition-colors duration-500">
              SOKO GLOBAL
            </span>
          </div>
        </Link>
