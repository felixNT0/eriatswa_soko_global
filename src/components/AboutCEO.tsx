        ...
        <div className="grid lg:grid-cols-2 gap-20 lg:gap-32 items-center">
          ...
          >
            <div className="aspect-[4/5] relative z-10 overflow-hidden rounded-3xl shadow-3xl group">
              ...
              <div className="absolute bottom-12 left-12 right-12">
                <p className="text-primary font-bold tracking-[0.4em] uppercase text-[10px] mb-4">
          ...
          <div className="relative z-20">
            ...
            <h2 className="text-6xl md:text-8xl font-display font-black mb-10 leading-[0.8] uppercase tracking-tighter">
              Redefining <br />
              <span className="text-outlined">Handmade Luxury.</span>
            </h2>

            <div className="space-y-8">
              <div className="space-y-6 text-stone-500 font-light leading-relaxed">
                <p className="text-xl md:text-2xl text-foreground font-medium italic mb-12">
                  &quot;Eriatswa Soko Global is a creative, handcrafted fashion
                  and lifestyle brand committed to delivering quality, elegance,
                  and excellence. We specialize in producing handmade bags,
                  shoes, bedsheets, and fashion accessories, combining skilled
                  craftsmanship with modern designs to create products that
                  stand out in style and durability.&quot;
                </p>
                ...
                <p>
                  With a focus on quality, originality, and customer
                  satisfaction, we serve individuals, retailers, and wholesalers
                  who appreciate well-made handmade items. Whether you need
                  custom designs, bulk orders, or unique fashion pieces, we
            ...
            <div className="mt-16">
              <a
                href="/about-ceo"
                className="group relative inline-flex items-center gap-6 text-primary font-bold uppercase tracking-[0.4em] text-[10px]"
              >
                ...
                <div className="w-12 h-12 rounded-full border border-primary/30 flex items-center justify-center group-hover:bg-primary group-hover:text-black transition-all duration-500 overflow-hidden">
                  <ArrowRight
                    size={16}
                    className="group-hover:translate-x-12 transition-transform duration-500"
                  />
                  <ArrowRight
                    size={16}
                    className="-translate-x-12 absolute group-hover:translate-x-0 transition-transform duration-500"
                  />
                </div>
              </a>
            </div>
