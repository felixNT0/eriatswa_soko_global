        ...
        <div className="flex flex-col lg:flex-row gap-24 items-start">
          <div className="lg:w-2/5 sticky top-32">
            ...
            <p className="text-muted-foreground leading-relaxed text-xl font-light max-w-md">
              Eriatswa Soko Global is a creative, handcrafted fashion and
              lifestyle brand committed to delivering quality, elegance, and
              excellence. We specialize in producing handmade bags, shoes,
          ...
          <div className="lg:w-3/5 grid grid-cols-1 md:grid-cols-2 gap-px bg-border/20 border border-border/10 shadow-3xl">
            {principles.map((item, i) => (
              ...
              >
                ...
                <h3 className="text-2xl font-display font-bold uppercase mb-6 tracking-tight group-hover:text-primary transition-colors">
                  {item.title}
                </h3>
