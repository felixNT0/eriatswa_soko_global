          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
            <div className="max-w-xl text-center lg:text-left">
              ...
              <h2 className="text-5xl md:text-7xl font-display font-black uppercase text-white mb-8 leading-[0.85] tracking-tighter">
                ...
                <span className="text-outlined">Inner Circle.</span>
              </h2>
              <p className="text-stone-400 text-lg md:text-xl font-light leading-relaxed">
                Curated insights from our atelier, exclusive early access to
                bespoke products, and the soulful stories behind our
                craftsmanship.
              </p>
            </div>
            ...
            <div className="w-full max-w-md">
              <form className="flex flex-col sm:flex-row gap-4">
                <div className="relative flex-1">
                  <Mail
                    className="absolute left-6 top-1/2 -translate-y-1/2 text-primary opacity-50"
                    size={20}
                  />
                  <input
                    type="email"
