...
const testimonials = [
  {
    ...
    content:
      "I needed bespoke leather souvenirs for my daughter's wedding. Eriatswa Soko not only delivered on time, but the quality was miles ahead of what I usually import. Proudly Nigerian excellence.",
  },
  {
    name: "Ibrahim Musa",
    role: "Lead Architect, Abuja",
    content:
      "The handcrafted briefcase I ordered is a masterpiece. It commands respect in every boardroom I enter. Seeing 'Made in Nigeria' with this level of finish is inspiring.",
  },
  {
    name: "Chidinma Okafor",
    role: "Academy Graduate, Class of '24",
    content:
      "Before the academy, I was just sketching designs. Now, I run my own shoemaking business in Enugu. The physical training in Ilorin was intense but worth every Kobo.",
  },
  {
    name: "Alhaji Yusuf Dankwambo",
    role: "Government Official, Kano",
    content:
      "We commissioned 200 leather jotters for a state summit. The precision, the branding, the packaging—everything shouted luxury. Eriatswa is a national treasure.",
  },
  {
    name: "Tega Oghenekaro",
    role: "Fashion Blogger, Lagos",
    content:
      "I've reviewed luxury bags from Milan to New York. The 'Zaria' tote stands toe-to-toe with them. The leather texture is buttery soft, and the gold hardware is solid.",
  },
  {
    name: "Biodun & Tiwa",
    role: "Couple, Wedding Souvenirs",
    content:
      "Our guests won't stop talking about the custom leather keyholders. Elegant, durable, and perfectly branded. Thank you Mrs. Lucy for making our day special.",
  },
];
